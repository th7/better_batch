require 'better_batch/multi_enum'

RSpec.describe BetterBatch::MultiEnum do
  let(:described_instance) { BetterBatch::MultiEnum.new }
  ...
  describe '#enums' do
    ...
    it 'returns enumeratorish things' do
      ...
      expect(a).to be_an(BetterBatch::LazierEnum)
      expect(b).to be_an(BetterBatch::LazierEnum)
      expect(c).to be_an(BetterBatch::LazierEnum)
    end
